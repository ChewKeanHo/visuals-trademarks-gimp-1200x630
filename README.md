# GNU Image Manipulation Program (GIMP) Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The GIMP Trademarks Logo. They published a full and clear guidelines for
deployment and supplied some material files for it. The preferred version is
...
This project re-draws GIMP Trademarks Logo specifically for 1200x630 size.
...
Please read through GIMP's Trademark Engineering Specification
(https://www.gimp.org/about/linking.html) before editing to avoid any unwanted
legal implications.

While not specified by GIMP, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: GNU Image Manipulation Program (GIMP) Trademarks Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-gimp-1200x630
UUID: 784F60C5-B10D-45A4-B847-553B9AF672A5
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-01
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-gimp-1200x630
--------------------------------------------------------------------------------
```
...
> COMPLY WITH GIMP TRADEMARK REQUIREMENTS
> (Read: https://www.gimp.org/about/linking.html)**.
>
